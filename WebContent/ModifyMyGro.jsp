							...
							<ul>
								<li>
									<div class="form-group">
										...
										<input type="text"
										 class="form-control" value='<s:property value="#session.username"/>'
										 placeholder="请输入更改后的昵称" name="username" required="required" >
									</div>
								</li>
								<br>
								<li>
								...
								<li>
									<div class="form-group">
										...
										<input type="text"
										 class="form-control" value='<s:property value="#request.zip"/>'
										 placeholder="请输入更改后的邮编" name="zip" required="required" >
									</div>
								</li><br>
								<li>
									<div class="form-group">
										...
										<input type="text"
										 class="form-control" value='<s:property value="#request.address"/>'
										 placeholder="请输入更改后的收货地址" name="address" required="required" >
									</div>
								</li><br>
								...
								<li>
									<div class="form-group">
										...
										<input type="text"
										 class="form-control" value='<s:property value="#request.tel"/>'
										 placeholder="请输入更改后的电话" name="tel" required="required" >
									</div>
								</li><br>
								<hr>
